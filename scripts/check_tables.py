...
def check_database_structure():
    ...
    with engine.connect() as conn:
        ...
        if views_data:
            ...
            print(tabulate(views_data, headers=['Vista', 'Descripción'], tablefmt='grid'))
        ...
        if triggers:
            ...
            print(tabulate(trigger_data, headers=['Trigger', 'Evento', 'Tabla'], tablefmt='grid'))
        ...
        print(f"   - Total objetos: {len(tables_data) + len(views_data) + len(triggers)}")
