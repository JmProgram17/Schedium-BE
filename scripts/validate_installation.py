...
def validate_environment():
    ...
    checks = {
        ...
        "Virtual environment active": hasattr(sys, 'real_prefix') or (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix)
    }
...
def validate_dependencies():
    ...
    required_packages = [
        ...
        "alembic", "pymysql", "python-jose", "passlib",
...
def validate_database_connection():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            print(f"{check_mark(table_count > 0)} Found {table_count} tables in database")
...
def validate_api_endpoints():
    ...
    endpoints = [
        "auth", "academic", "hr", "infrastructure", "scheduling", "health"
    ]
...
def validate_security():
    ...
    try:
        ...
        checks = {
            ...
            "SECRET_KEY not default": settings.SECRET_KEY not in ["CHANGE-THIS-SECRET-KEY", "secret"],
