...
class ContractBase(BaseSchema):
    ...
    contract_type: str = Field(..., min_length=2, max_length=100, description="Contract type")
    hour_limit: Optional[int] = Field(None, gt=0, le=200, description="Hour limit per period")
