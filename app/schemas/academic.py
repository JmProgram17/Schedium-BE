...
class LevelBase(BaseSchema):
    ...
    study_type: str = Field(..., min_length=2, max_length=100, description="Type of study")
    duration: Optional[int] = Field(None, gt=0, le=120, description="Duration in months")
...
class StudentGroupDisable(BaseSchema):
    ...
    reason: Optional[str] = Field(None, max_length=255, description="Reason for disabling")