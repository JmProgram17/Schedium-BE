...
async def get_departments(
    ...
    return SuccessResponse(
        data=departments, message="Departments retrieved successfully"
    )
...
async def create_department(
    ...
    return CreatedResponse(data=department, message="Department created successfully")
...
async def get_department(
    ...
    return SuccessResponse(data=department, message="Department retrieved successfully")
...
async def update_department(
    ...
    return UpdatedResponse(data=department, message="Department updated successfully")
...
async def delete_department(
    ...
    return DeletedResponse(message="Department deleted successfully")
...
async def get_contracts(
    ...
    return SuccessResponse(data=contracts, message="Contracts retrieved successfully")
...
async def create_contract(
    ...
    return CreatedResponse(data=contract, message="Contract created successfully")
...
async def get_contract(
    ...
    return SuccessResponse(data=contract, message="Contract retrieved successfully")
...
async def update_contract(
    ...
    return UpdatedResponse(data=contract, message="Contract updated successfully")
...
async def delete_contract(
    ...
    return DeletedResponse(message="Contract deleted successfully")
...
async def get_instructors(
    ...
    return SuccessResponse(
        data=instructors, message="Instructors retrieved successfully"
    )
...
async def create_instructor(
    ...
    return CreatedResponse(data=instructor, message="Instructor created successfully")
...
async def get_instructor(
    ...
    return SuccessResponse(data=instructor, message="Instructor retrieved successfully")
...
async def update_instructor(
    ...
    return UpdatedResponse(data=instructor, message="Instructor updated successfully")
...
async def delete_instructor(
    ...
    return DeletedResponse(message="Instructor deleted successfully")
...
async def get_instructor_workload(
    ...
    return SuccessResponse(
        data=workload, message="Instructor workload retrieved successfully"
    )
...
async def get_instructor_schedule(
    ...
    return SuccessResponse(
        data=schedules, message="Instructor schedule retrieved successfully"
    )
