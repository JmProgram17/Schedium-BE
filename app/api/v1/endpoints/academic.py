...
async def get_levels(
    ...
    return SuccessResponse(data=levels, message="Levels retrieved successfully")
...
async def create_level(
    ...
    return CreatedResponse(data=level, message="Level created successfully")
...
async def get_level(
    ...
    return SuccessResponse(data=level, message="Level retrieved successfully")
...
async def update_level(
    ...
    return UpdatedResponse(data=level, message="Level updated successfully")
...
async def delete_level(
    ...
    return DeletedResponse(message="Level deleted successfully")
...
async def get_chains(
    ...
    return SuccessResponse(data=chains, message="Chains retrieved successfully")
...
async def create_chain(
    ...
    return CreatedResponse(data=chain, message="Chain created successfully")
...
async def get_chain(
    ...
    return SuccessResponse(data=chain, message="Chain retrieved successfully")
...
async def update_chain(
    ...
    return UpdatedResponse(data=chain, message="Chain updated successfully")
...
async def delete_chain(
    ...
    return DeletedResponse(message="Chain deleted successfully")
...
async def get_nomenclatures(
    ...
    return SuccessResponse(
        data=nomenclatures, message="Nomenclatures retrieved successfully"
    )
...
async def create_nomenclature(
    ...
    return CreatedResponse(
        data=nomenclature, message="Nomenclature created successfully"
    )
...
async def get_nomenclature(
    ...
    return SuccessResponse(
        data=nomenclature, message="Nomenclature retrieved successfully"
    )
...
async def update_nomenclature(
    ...
    return UpdatedResponse(
        data=nomenclature, message="Nomenclature updated successfully"
    )
...
async def delete_nomenclature(
    ...
    return DeletedResponse(message="Nomenclature deleted successfully")
...
async def get_programs(
    ...
    return SuccessResponse(data=programs, message="Programs retrieved successfully")
...
async def create_program(
    ...
    return CreatedResponse(data=program, message="Program created successfully")
...
async def get_program(
    ...
    return SuccessResponse(data=program, message="Program retrieved successfully")
...
async def update_program(
    ...
    return UpdatedResponse(data=program, message="Program updated successfully")
...
async def delete_program(
    ...
    return DeletedResponse(message="Program deleted successfully")
...
async def get_student_groups(
    ...
    return SuccessResponse(data=groups, message="Student groups retrieved successfully")
...
async def create_student_group(
    ...
    return CreatedResponse(data=group, message="Student group created successfully")
...
async def get_student_group(
    ...
    return SuccessResponse(data=group, message="Student group retrieved successfully")
...
async def update_student_group(
    ...
    return UpdatedResponse(data=group, message="Student group updated successfully")
...
async def disable_student_group(
    ...
    return UpdatedResponse(data=group, message="Student group disabled successfully")
...
async def delete_student_group(
    ...
    return DeletedResponse(message="Student group deleted successfully")
