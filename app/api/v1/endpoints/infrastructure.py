...
async def get_campuses(
    ...
    return SuccessResponse(data=campuses, message="Campuses retrieved successfully")
...
async def create_campus(
    ...
    return CreatedResponse(data=campus, message="Campus created successfully")
...
async def get_campus(
    ...
    return SuccessResponse(data=campus, message="Campus retrieved successfully")
...
async def update_campus(
    ...
    return UpdatedResponse(data=campus, message="Campus updated successfully")
...
async def delete_campus(
    ...
    return DeletedResponse(message="Campus deleted successfully")
...
async def get_classrooms(
    ...
    return SuccessResponse(data=classrooms, message="Classrooms retrieved successfully")
...
async def create_classroom(
    ...
    return CreatedResponse(data=classroom, message="Classroom created successfully")
...
async def get_classroom(
    ...
    return SuccessResponse(data=classroom, message="Classroom retrieved successfully")
...
async def update_classroom(
    ...
    return UpdatedResponse(data=classroom, message="Classroom updated successfully")
...
async def delete_classroom(
    ...
    return DeletedResponse(message="Classroom deleted successfully")
...
async def get_classroom_availability(
    ...
    return SuccessResponse(
        data=availability, message="Classroom availability retrieved successfully"
    )
...
async def assign_classroom_to_department(
    ...
    return CreatedResponse(
        data=dept_classroom, message="Classroom assigned to department successfully"
    )
...
async def update_classroom_assignment(
    ...
    return UpdatedResponse(data=assignment, message="Assignment updated successfully")
...
async def remove_classroom_assignment(
    ...
    return DeletedResponse(message="Assignment removed successfully")
...
async def get_department_classrooms(
    ...
    return SuccessResponse(
        data=assignments, message="Department classrooms retrieved successfully"
    )
