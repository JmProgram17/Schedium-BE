...
from app.schemas.academic import (
    LevelCreate, LevelUpdate, Level as LevelSchema,
    ChainCreate, ChainUpdate, Chain as ChainSchema,
    NomenclatureCreate, NomenclatureUpdate, Nomenclature as NomenclatureSchema,
    ProgramCreate, ProgramUpdate, Program as ProgramSchema,
    StudentGroupCreate, StudentGroupUpdate, StudentGroup as StudentGroupSchema,
    StudentGroupDisable
)
...
class AcademicService:
    ...
    def update_program(self, program_id: int, program_in: ProgramUpdate) -> ProgramSchema:
        """Update program."""
    ...
    def get_student_groups(
        ...
        page = self.group_repo.search_groups(
            params, search, program_id, schedule_id,
            active, start_date_from, start_date_to
        )
    ...
    def disable_student_group(
        ...
        if not group.active:
            raise BadRequestException(
                detail="Group is already disabled",
                error_code="GROUP_ALREADY_DISABLED"
            )
