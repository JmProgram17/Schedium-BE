...
def include_object(object, name, type_, reflected, compare_to):
    ...
    Exclude views and other database objects we don't want to track.
    """
    # Skip views
...
def render_item(type_, obj, autogen_context):
    """
    Custom render for certain types.
    Helps with MySQL specific types.
    """
    if type_ == "type":
